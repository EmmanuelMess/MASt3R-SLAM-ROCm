...
class Retriever(object):
    def __init__(self, modelname, backbone=None, device='cuda'):
        ...
        ckpt = torch.load(modelname, 'cpu', weights_only=False)  # TODO weights_only can result in arbitrary code execution  # TODO from pretrained to download it automatically
        ckpt_args = ckpt['args']
        if backbone is None:
